...
train_dataset = ImageToImage2D(imgsize, args.train_dataset, tf_train)
val_dataset = ImageToImage2D(imgsize, args.val_dataset, tf_val)
predict_dataset = Image2D(imgsize, args.val_dataset)
